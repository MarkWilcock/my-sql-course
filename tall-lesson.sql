...
WITH E1 AS (
	    SELECT 1 AS Col1 UNION ALL SELECT 1 UNION ALL SELECT 1 UNION ALL SELECT 1 UNION ALL SELECT 1
	    UNION ALL SELECT 1 UNION ALL SELECT 1 UNION ALL SELECT 1 UNION ALL SELECT 1 UNION ALL SELECT 1 
	)
	, E2 AS ( SELECT * FROM E1 a CROSS JOIN E1 b)
    , E4 AS ( SELECT * FROM E2 a CROSS JOIN E2 b)
SELECT
